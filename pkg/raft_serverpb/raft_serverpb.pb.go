...
type MergePhase int32

const (
	MergePhase_NoMerge MergePhase = 0
	MergePhase_Prepare MergePhase = 1
	MergePhase_Commit  MergePhase = 3
)

var MergePhase_name = map[int32]string{
	0: "NoMerge",
	1: "Prepare",
	3: "Commit",
}
var MergePhase_value = map[string]int32{
	"NoMerge": 0,
	"Prepare": 1,
	"Commit":  3,
}

func (x MergePhase) Enum() *MergePhase {
	p := new(MergePhase)
	*p = x
	return p
}
func (x MergePhase) String() string {
	return proto.EnumName(MergePhase_name, int32(x))
}
func (x *MergePhase) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(MergePhase_value, data, "MergePhase")
	if err != nil {
		return err
	}
	*x = MergePhase(value)
...
func (MergePhase) EnumDescriptor() ([]byte, []int) { return fileDescriptorRaftServerpb, []int{0} }
...
const (
	...
	PeerState_Suspended PeerState = 3
)
...
func (PeerState) EnumDescriptor() ([]byte, []int) { return fileDescriptorRaftServerpb, []int{1} }
...
type RegionMergeState struct {
	Phase            *MergePhase    `protobuf:"varint,1,opt,name=phase,enum=raft_serverpb.MergePhase" json:"phase,omitempty"`
	ToMerge          *metapb.Region `protobuf:"bytes,2,opt,name=to_merge,json=toMerge" json:"to_merge,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *RegionMergeState) GetPhase() MergePhase {
	if m != nil && m.Phase != nil {
		return *m.Phase
	}
	return MergePhase_NoMerge
}

func (m *RegionMergeState) GetToMerge() *metapb.Region {
	if m != nil {
		return m.ToMerge
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("raft_serverpb.MergePhase", MergePhase_name, MergePhase_value)
...
func (m *RegionMergeState) MarshalTo(data []byte) (int, error) {
	...
	if m.Phase != nil {
		data[i] = 0x8
		i++
		i = encodeVarintRaftServerpb(data, i, uint64(*m.Phase))
	}
	if m.ToMerge != nil {
		data[i] = 0x12
		i++
		i = encodeVarintRaftServerpb(data, i, uint64(m.ToMerge.Size()))
		n8, err := m.ToMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *RegionMergeState) Size() (n int) {
	...
	_ = l
	if m.Phase != nil {
		n += 1 + sovRaftServerpb(uint64(*m.Phase))
	}
	if m.ToMerge != nil {
		l = m.ToMerge.Size()
		n += 1 + l + sovRaftServerpb(uint64(l))
...
func (m *RegionMergeState) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToMerge", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ToMerge == nil {
				m.ToMerge = &metapb.Region{}
			}
			if err := m.ToMerge.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorRaftServerpb = []byte{
	...
	,
}
