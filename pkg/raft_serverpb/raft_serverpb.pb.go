...
type RegionMergeState int32

const (
	RegionMergeState_NoMerge   RegionMergeState = 0
	RegionMergeState_Merging   RegionMergeState = 1
	RegionMergeState_Suspended RegionMergeState = 2
)

var RegionMergeState_name = map[int32]string{
	0: "NoMerge",
	1: "Merging",
	2: "Suspended",
}
var RegionMergeState_value = map[string]int32{
	"NoMerge":   0,
	"Merging":   1,
	"Suspended": 2,
}

func (x RegionMergeState) Enum() *RegionMergeState {
	p := new(RegionMergeState)
	*p = x
	return p
}
func (x RegionMergeState) String() string {
	return proto.EnumName(RegionMergeState_name, int32(x))
}
func (x *RegionMergeState) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(RegionMergeState_value, data, "RegionMergeState")
	if err != nil {
		return err
	}
	*x = RegionMergeState(value)
	return nil
}
func (RegionMergeState) EnumDescriptor() ([]byte, []int) { return fileDescriptorRaftServerpb, []int{1} }
...
type RegionLocalState struct {
	...
	MergeState       *RegionMergeState `protobuf:"varint,3,opt,name=merge_state,json=mergeState,enum=raft_serverpb.RegionMergeState" json:"merge_state,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}
...
func (m *RegionLocalState) GetMergeState() RegionMergeState {
	if m != nil && m.MergeState != nil {
		return *m.MergeState
	}
	return RegionMergeState_NoMerge
}
...
func init() {
	...
	proto.RegisterEnum("raft_serverpb.RegionMergeState", RegionMergeState_name, RegionMergeState_value)
}
...
func (m *RegionLocalState) MarshalTo(data []byte) (int, error) {
	...
	if m.MergeState != nil {
		data[i] = 0x18
		i++
		i = encodeVarintRaftServerpb(data, i, uint64(*m.MergeState))
	}
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
...
func (m *RegionLocalState) Size() (n int) {
	...
	if m.MergeState != nil {
		n += 1 + sovRaftServerpb(uint64(*m.MergeState))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				v |= (RegionMergeState(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorRaftServerpb = []byte{
	...
	,
}
