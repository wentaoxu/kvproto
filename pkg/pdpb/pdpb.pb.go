...
const (
	...
	CommandType_ReportMerge      CommandType = 16
)
...
func (*RegionShutdown) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{24} }
...
// 1. do a raft write to [a, b) to persist the merging region info into the region state
// 2. do a raft write to [b, c) to suspend its processing of client read/write requests
// 3. do a raft write to [a, b) to commit its region extension to [a, c)
// 4. report to Pd that the region merge phase 2 is done
// 5. do a raft write to [b, c) to tell it to shutdown
// If step 4 fails due to exception such as request loss, the heartbeat communication
// between PD and region [a, c) will cause PD to update the new region info.
// If step 5 fails due to exception such as request loss, the communication
// between PD and the old region [b, c) will cause the old region to shutdown.
type ReportMergeRequest struct {
	...
	ToShutdown       *metapb.Region `protobuf:"bytes,3,opt,name=to_shutdown,json=toShutdown" json:"to_shutdown,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *ReportMergeRequest) GetToShutdown() *metapb.Region {
	if m != nil {
		return m.ToShutdown
	}
	return nil
...
type Request struct {
	...
	AskMerge         *AskMergeRequest         `protobuf:"bytes,17,opt,name=ask_merge,json=askMerge" json:"ask_merge,omitempty"`
	ReportMerge      *ReportMergeRequest      `protobuf:"bytes,18,opt,name=report_merge,json=reportMerge" json:"report_merge,omitempty"`
	XXX_unrecognized []byte                   `json:"-"`
}
...
func (m *Request) GetReportMerge() *ReportMergeRequest {
	if m != nil {
		return m.ReportMerge
	}
	return nil
}
...
type Response struct {
	...
	AskMerge         *AskMergeResponse         `protobuf:"bytes,17,opt,name=ask_merge,json=askMerge" json:"ask_merge,omitempty"`
	ReportMerge      *ReportMergeResponse      `protobuf:"bytes,18,opt,name=report_merge,json=reportMerge" json:"report_merge,omitempty"`
	XXX_unrecognized []byte                    `json:"-"`
}
...
func (m *Response) GetReportMerge() *ReportMergeResponse {
	if m != nil {
		return m.ReportMerge
	}
	return nil
...
func (m *ReportMergeRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.Old != nil {
		...
		n28, err := m.Old.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.ToShutdown != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ToShutdown.Size()))
		n29, err := m.ToShutdown.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n29
...
func (m *Request) MarshalTo(data []byte) (int, error) {
	...
	if m.Tso != nil {
		...
		n32, err := m.Tso.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
	...
	if m.Bootstrap != nil {
		...
		n33, err := m.Bootstrap.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n33
	...
	if m.IsBootstrapped != nil {
		...
		n34, err := m.IsBootstrapped.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	...
	if m.AllocId != nil {
		...
		n35, err := m.AllocId.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.GetStore != nil {
		...
		n36, err := m.GetStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n36
	...
	if m.PutStore != nil {
		...
		n37, err := m.PutStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	if m.AskSplit != nil {
		...
		n38, err := m.AskSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n38
	...
	if m.GetRegion != nil {
		...
		n39, err := m.GetRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n39
	...
	if m.RegionHeartbeat != nil {
		...
		n40, err := m.RegionHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if m.GetClusterConfig != nil {
		...
		n41, err := m.GetClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	if m.PutClusterConfig != nil {
		...
		n42, err := m.PutClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.StoreHeartbeat != nil {
		...
		n43, err := m.StoreHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.ReportSplit != nil {
		...
		n44, err := m.ReportSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.GetRegionById != nil {
		...
		n45, err := m.GetRegionById.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	...
	if m.AskMerge != nil {
		...
		n46, err := m.AskMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n46
	}
	if m.ReportMerge != nil {
		data[i] = 0x92
		i++
		data[i] = 0x1
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ReportMerge.Size()))
		n47, err := m.ReportMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *Response) MarshalTo(data []byte) (int, error) {
	...
	if m.Tso != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.Tso.Size()))
		n49, err := m.Tso.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	if m.Bootstrap != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.Bootstrap.Size()))
		n50, err := m.Bootstrap.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n50
	...
	if m.IsBootstrapped != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.IsBootstrapped.Size()))
		n51, err := m.IsBootstrapped.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.AllocId != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AllocId.Size()))
		n52, err := m.AllocId.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n52
	...
	if m.GetStore != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetStore.Size()))
		n53, err := m.GetStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n53
	...
	if m.PutStore != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.PutStore.Size()))
		n54, err := m.PutStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n54
	...
	if m.AskSplit != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AskSplit.Size()))
		n55, err := m.AskSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n55
	...
	if m.GetRegion != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetRegion.Size()))
		n56, err := m.GetRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n56
	...
	if m.RegionHeartbeat != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.RegionHeartbeat.Size()))
		n57, err := m.RegionHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n57
	...
	if m.GetClusterConfig != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetClusterConfig.Size()))
		n58, err := m.GetClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n58
	...
	if m.PutClusterConfig != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.PutClusterConfig.Size()))
		n59, err := m.PutClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n59
	...
	if m.StoreHeartbeat != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.StoreHeartbeat.Size()))
		n60, err := m.StoreHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n60
	...
	if m.ReportSplit != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ReportSplit.Size()))
		n61, err := m.ReportSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n61
	...
	if m.GetRegionById != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetRegionById.Size()))
		n62, err := m.GetRegionById.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n62
	...
	if m.AskMerge != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AskMerge.Size()))
		n63, err := m.AskMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n63
	...
	if m.ReportMerge != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ReportMerge.Size()))
		n64, err := m.ReportMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *Error) MarshalTo(data []byte) (int, error) {
	...
	if m.Bootstrapped != nil {
		...
		n65, err := m.Bootstrapped.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n65
	...
	if m.IsTombstone != nil {
		...
		n66, err := m.IsTombstone.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *ReportMergeRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToShutdown", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ToShutdown == nil {
				m.ToShutdown = &metapb.Region{}
			}
			if err := m.ToShutdown.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Request) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReportMerge", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ReportMerge == nil {
				m.ReportMerge = &ReportMergeRequest{}
			}
			if err := m.ReportMerge.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Response) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			...
			if m.ReportMerge == nil {
				m.ReportMerge = &ReportMergeResponse{}
			}
			if err := m.ReportMerge.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
...
var fileDescriptorPdpb = []byte{
	...
	,
}
