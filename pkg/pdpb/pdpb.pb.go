...
type RegionMerge struct {
	...
	FromLeader       *metapb.Peer   `protobuf:"bytes,2,opt,name=from_leader,json=fromLeader" json:"from_leader,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *RegionMerge) GetFromLeader() *metapb.Peer {
	if m != nil {
		return m.FromLeader
	}
	return nil
...
func (m *RegionMerge) MarshalTo(data []byte) (int, error) {
	...
	if m.FromLeader != nil {
		data[i] = 0x12
		i++
		i = encodeVarintPdpb(data, i, uint64(m.FromLeader.Size()))
		n15, err := m.FromLeader.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *RegionHeartbeatResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.RegionShutdown != nil {
		...
		n20, err := m.RegionShutdown.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *ReportMergeRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.ToShutdown != nil {
		...
		n30, err := m.ToShutdown.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *Request) MarshalTo(data []byte) (int, error) {
	...
	if m.AskMerge != nil {
		...
		n47, err := m.AskMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.ReportMerge != nil {
		...
		n48, err := m.ReportMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *Response) MarshalTo(data []byte) (int, error) {
	...
	if m.Tso != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.Tso.Size()))
		n50, err := m.Tso.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n50
	...
	if m.Bootstrap != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.Bootstrap.Size()))
		n51, err := m.Bootstrap.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if m.IsBootstrapped != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.IsBootstrapped.Size()))
		n52, err := m.IsBootstrapped.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n52
	...
	if m.AllocId != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AllocId.Size()))
		n53, err := m.AllocId.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n53
	...
	if m.GetStore != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetStore.Size()))
		n54, err := m.GetStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n54
	...
	if m.PutStore != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.PutStore.Size()))
		n55, err := m.PutStore.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n55
	...
	if m.AskSplit != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AskSplit.Size()))
		n56, err := m.AskSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n56
	...
	if m.GetRegion != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetRegion.Size()))
		n57, err := m.GetRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n57
	...
	if m.RegionHeartbeat != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.RegionHeartbeat.Size()))
		n58, err := m.RegionHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n58
	...
	if m.GetClusterConfig != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetClusterConfig.Size()))
		n59, err := m.GetClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n59
	...
	if m.PutClusterConfig != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.PutClusterConfig.Size()))
		n60, err := m.PutClusterConfig.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n60
	...
	if m.StoreHeartbeat != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.StoreHeartbeat.Size()))
		n61, err := m.StoreHeartbeat.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n61
	...
	if m.ReportSplit != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ReportSplit.Size()))
		n62, err := m.ReportSplit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n62
	...
	if m.GetRegionById != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.GetRegionById.Size()))
		n63, err := m.GetRegionById.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n63
	...
	if m.AskMerge != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.AskMerge.Size()))
		n64, err := m.AskMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n64
	...
	if m.ReportMerge != nil {
		...
		i++
		i = encodeVarintPdpb(data, i, uint64(m.ReportMerge.Size()))
		n65, err := m.ReportMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *Error) MarshalTo(data []byte) (int, error) {
	...
	if m.Bootstrapped != nil {
		...
		n66, err := m.Bootstrapped.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n66
	...
	if m.IsTombstone != nil {
		...
		n67, err := m.IsTombstone.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n67
...
func (m *RegionMerge) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.FromLeader == nil {
				m.FromLeader = &metapb.Peer{}
			}
			if err := m.FromLeader.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorPdpb = []byte{
	...
	,
}
