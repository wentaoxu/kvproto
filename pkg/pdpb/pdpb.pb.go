...
type GetGCInfoRequest struct {
	Header *RequestHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *GetGCInfoRequest) Reset()                    { *m = GetGCInfoRequest{} }
func (m *GetGCInfoRequest) String() string            { return proto.CompactTextString(m) }
func (*GetGCInfoRequest) ProtoMessage()               {}
func (*GetGCInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{42} }

func (m *GetGCInfoRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
type GetGCInfoResponse struct {
	Header    *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	Safepoint uint64          `protobuf:"varint,2,opt,name=safepoint,proto3" json:"safepoint,omitempty"`
	Duration  uint64          `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"`
}

func (m *GetGCInfoResponse) Reset()                    { *m = GetGCInfoResponse{} }
func (m *GetGCInfoResponse) String() string            { return proto.CompactTextString(m) }
func (*GetGCInfoResponse) ProtoMessage()               {}
func (*GetGCInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{43} }

func (m *GetGCInfoResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *GetGCInfoResponse) GetSafepoint() uint64 {
	if m != nil {
		return m.Safepoint
	}
	return 0
...
func (m *GetGCInfoResponse) GetDuration() uint64 {
	if m != nil {
		return m.Duration
	}
	return 0
...
type PutGCInfoRequest struct {
	Header    *RequestHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
	Safepoint uint64         `protobuf:"varint,2,opt,name=safepoint,proto3" json:"safepoint,omitempty"`
	Duration  uint64         `protobuf:"varint,3,opt,name=duration,proto3" json:"duration,omitempty"`
}

func (m *PutGCInfoRequest) Reset()                    { *m = PutGCInfoRequest{} }
func (m *PutGCInfoRequest) String() string            { return proto.CompactTextString(m) }
func (*PutGCInfoRequest) ProtoMessage()               {}
func (*PutGCInfoRequest) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{44} }

func (m *PutGCInfoRequest) GetHeader() *RequestHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func (m *PutGCInfoRequest) GetSafepoint() uint64 {
	if m != nil {
		return m.Safepoint
	}
	return 0
...
func (m *PutGCInfoRequest) GetDuration() uint64 {
	if m != nil {
		return m.Duration
	}
	return 0
...
type PutGCInfoResponse struct {
	Header *ResponseHeader `protobuf:"bytes,1,opt,name=header" json:"header,omitempty"`
}

func (m *PutGCInfoResponse) Reset()                    { *m = PutGCInfoResponse{} }
func (m *PutGCInfoResponse) String() string            { return proto.CompactTextString(m) }
func (*PutGCInfoResponse) ProtoMessage()               {}
func (*PutGCInfoResponse) Descriptor() ([]byte, []int) { return fileDescriptorPdpb, []int{45} }

func (m *PutGCInfoResponse) GetHeader() *ResponseHeader {
	if m != nil {
		return m.Header
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*GetGCInfoRequest)(nil), "pdpb.GetGCInfoRequest")
	proto.RegisterType((*GetGCInfoResponse)(nil), "pdpb.GetGCInfoResponse")
	proto.RegisterType((*PutGCInfoRequest)(nil), "pdpb.PutGCInfoRequest")
	proto.RegisterType((*PutGCInfoResponse)(nil), "pdpb.PutGCInfoResponse")
...
type PDClient interface {
	...
	GetGCInfo(ctx context.Context, in *GetGCInfoRequest, opts ...grpc.CallOption) (*GetGCInfoResponse, error)
	PutGCInfo(ctx context.Context, in *PutGCInfoRequest, opts ...grpc.CallOption) (*PutGCInfoResponse, error)
}
...
func (c *pDClient) GetGCInfo(ctx context.Context, in *GetGCInfoRequest, opts ...grpc.CallOption) (*GetGCInfoResponse, error) {
	out := new(GetGCInfoResponse)
	err := grpc.Invoke(ctx, "/pdpb.PD/GetGCInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pDClient) PutGCInfo(ctx context.Context, in *PutGCInfoRequest, opts ...grpc.CallOption) (*PutGCInfoResponse, error) {
	out := new(PutGCInfoResponse)
	err := grpc.Invoke(ctx, "/pdpb.PD/PutGCInfo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PDServer interface {
	...
	GetGCInfo(context.Context, *GetGCInfoRequest) (*GetGCInfoResponse, error)
	PutGCInfo(context.Context, *PutGCInfoRequest) (*PutGCInfoResponse, error)
}
...
func _PD_GetGCInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGCInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).GetGCInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/GetGCInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).GetGCInfo(ctx, req.(*GetGCInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PD_PutGCInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PutGCInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PDServer).PutGCInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdpb.PD/PutGCInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PDServer).PutGCInfo(ctx, req.(*PutGCInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _PD_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetGCInfo",
			Handler:    _PD_GetGCInfo_Handler,
		},
		{
			MethodName: "PutGCInfo",
			Handler:    _PD_PutGCInfo_Handler,
		},
	},
...
func (m *GetGCInfoRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetGCInfoRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetGCInfoResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *GetGCInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.Duration != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintPdpb(dAtA, i, uint64(m.Duration))
	}
	return i, nil
}

func (m *PutGCInfoRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PutGCInfoRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *PutGCInfoResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PutGCInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *GetGCInfoRequest) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *GetGCInfoResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
	...
	if m.Duration != 0 {
		n += 1 + sovPdpb(uint64(m.Duration))
	}
	return n
}

func (m *PutGCInfoRequest) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *PutGCInfoResponse) Size() (n int) {
	var l int
	_ = l
	if m.Header != nil {
		l = m.Header.Size()
...
func (m *GetGCInfoRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetGCInfoRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetGCInfoRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GetGCInfoResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetGCInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetGCInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PutGCInfoRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PutGCInfoRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PutGCInfoRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *PutGCInfoResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PutGCInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PutGCInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorPdpb = []byte{
	...
	,
}
