...
func (m *Tm) Reset()                    { *m = Tm{} }
func (m *Tm) String() string            { return proto.CompactTextString(m) }
func (*Tm) ProtoMessage()               {}
func (*Tm) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{28} }

func (m *Tm) GetSec() int64 {
	if m != nil && m.Sec != nil {
		return *m.Sec
	}
	return 0
...
type Trace struct {
	ArriveTime       *Tm    `protobuf:"bytes,1,opt,name=arrive_time,json=arriveTime" json:"arrive_time,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (*Trace) Descriptor() ([]byte, []int) { return fileDescriptorRaftCmdpb, []int{29} }

func (m *Trace) GetArriveTime() *Tm {
	if m != nil {
		return m.ArriveTime
	}
	return nil
...
type RaftRequestHeader struct {
	...
	Trace            *Trace              `protobuf:"bytes,7,opt,name=trace" json:"trace,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
...
func (m *RaftRequestHeader) GetTrace() *Trace {
	if m != nil {
		return m.Trace
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Tm)(nil), "raft_cmdpb.Tm")
	proto.RegisterType((*Trace)(nil), "raft_cmdpb.Trace")
...
func (m *Tm) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *Tm) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Sec == nil {
		...
		dAtA[i] = 0x8
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(*m.Sec))
	}
	if m.Nsec == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x10
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(*m.Nsec))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *Trace) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ArriveTime != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.ArriveTime.Size()))
		n32, err := m.ArriveTime.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *RaftRequestHeader) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RegionEpoch != nil {
		...
		n34, err := m.RegionEpoch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
	...
	if m.Trace != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintRaftCmdpb(dAtA, i, uint64(m.Trace.Size()))
...
func (m *RaftCmdRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdminRequest != nil {
		...
		n38, err := m.AdminRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
	...
	if m.StatusRequest != nil {
		...
		n39, err := m.StatusRequest.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *RaftCmdResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AdminResponse != nil {
		...
		n41, err := m.AdminResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	if m.StatusResponse != nil {
		...
		n42, err := m.StatusResponse.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *Tm) Size() (n int) {
	var l int
	_ = l
	if m.Sec != nil {
		n += 1 + sovRaftCmdpb(uint64(*m.Sec))
	}
	if m.Nsec != nil {
		n += 1 + sovRaftCmdpb(uint64(*m.Nsec))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Tm) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Tm: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Tm: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Trace) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := m.ArriveTime.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
