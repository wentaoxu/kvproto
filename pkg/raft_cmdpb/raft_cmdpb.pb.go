...
func (m *MergeRequest) GetFromLeader() *metapb.Peer {
	if m != nil {
		return m.FromLeader
	}
	return nil
...
func (m *SuspendRegionRequest) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *SuspendRegionResponse) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
type CommitMergeRequest struct {
	FromRegion       *metapb.Region `protobuf:"bytes,1,opt,name=from_region,json=fromRegion" json:"from_region,omitempty"`
	FromLeader       *metapb.Peer   `protobuf:"bytes,2,opt,name=from_leader,json=fromLeader" json:"from_leader,omitempty"`
	IntoRegion       *metapb.Region `protobuf:"bytes,3,opt,name=into_region,json=intoRegion" json:"into_region,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *CommitMergeRequest) GetFromLeader() *metapb.Peer {
	if m != nil {
		return m.FromLeader
	}
	return nil
...
func (m *CommitMergeRequest) GetIntoRegion() *metapb.Region {
	if m != nil {
		return m.IntoRegion
	}
	return nil
...
func (m *CommitMergeResponse) GetIntoRegion() *metapb.Region {
	if m != nil {
		return m.IntoRegion
	}
	return nil
...
func (m *ShutdownRegionResponse) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *MergeRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.FromLeader != nil {
		data[i] = 0x12
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.FromLeader.Size()))
...
func (m *CommitMergeRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.FromLeader != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.FromLeader.Size()))
		n19, err := m.FromLeader.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.IntoRegion != nil {
		...
		n20, err := m.IntoRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *CommitMergeResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.IntoRegion != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.IntoRegion.Size()))
		n21, err := m.IntoRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *AdminRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.Split != nil {
		...
		n26, err := m.Split.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n26
	...
	if m.CompactLog != nil {
		...
		n27, err := m.CompactLog.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
	...
	if m.TransferLeader != nil {
		...
		n28, err := m.TransferLeader.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n28
	...
	if m.Merge != nil {
		...
		n29, err := m.Merge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.SuspendRegion != nil {
		...
		n30, err := m.SuspendRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.CommitMerge != nil {
		...
		n31, err := m.CommitMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n31
	...
	if m.ShutdownRegion != nil {
		...
		n32, err := m.ShutdownRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *AdminResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.Merge != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.Merge.Size()))
		n37, err := m.Merge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	if m.SuspendRegion != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.SuspendRegion.Size()))
		n38, err := m.SuspendRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n38
	...
	if m.CommitMerge != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.CommitMerge.Size()))
		n39, err := m.CommitMerge.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n39
	...
	if m.ShutdownRegion != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.ShutdownRegion.Size()))
		n40, err := m.ShutdownRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
