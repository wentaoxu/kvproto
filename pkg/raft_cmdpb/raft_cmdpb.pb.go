...
func (m *MergeRequest) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *MergeRequest) GetLeader() *metapb.Peer {
	if m != nil {
		return m.Leader
	}
	return nil
...
type CommitMergeRequest struct {
	Region           *metapb.Region `protobuf:"bytes,1,opt,name=region" json:"region,omitempty"`
	Leader           *metapb.Peer   `protobuf:"bytes,2,opt,name=leader" json:"leader,omitempty"`
	LocalRegion      *metapb.Region `protobuf:"bytes,3,opt,name=local_region,json=localRegion" json:"local_region,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *CommitMergeRequest) GetRegion() *metapb.Region {
	if m != nil {
		return m.Region
	}
	return nil
...
func (m *CommitMergeRequest) GetLeader() *metapb.Peer {
	if m != nil {
		return m.Leader
	}
	return nil
...
func (m *CommitMergeRequest) GetLocalRegion() *metapb.Region {
	if m != nil {
...
type CommitMergeResponse struct {
	LocalRegion      *metapb.Region `protobuf:"bytes,1,opt,name=local_region,json=localRegion" json:"local_region,omitempty"`
	XXX_unrecognized []byte         `json:"-"`
}
...
func (m *CommitMergeResponse) GetLocalRegion() *metapb.Region {
	if m != nil {
		return m.LocalRegion
	}
	return nil
...
func (m *CommitMergeRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.Leader != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.Leader.Size()))
		n19, err := m.Leader.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.LocalRegion != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.LocalRegion.Size()))
		n20, err := m.LocalRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
func (m *CommitMergeResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.LocalRegion != nil {
		...
		i++
		i = encodeVarintRaftCmdpb(data, i, uint64(m.LocalRegion.Size()))
		n21, err := m.LocalRegion.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n21
...
func (m *CommitMergeRequest) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.LocalRegion == nil {
				m.LocalRegion = &metapb.Region{}
			}
			if err := m.LocalRegion.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorRaftCmdpb = []byte{
	...
	,
}
