...
type RegionMerge struct {
	State MergeState `protobuf:"varint,1,opt,name=state,enum=metapb.MergeState" json:"state"`
	// The ID of the merging region.
	// If the region ID equals this ID, it is the control region.
	IntoId uint64 `protobuf:"varint,2,opt,name=into_id,json=intoId" json:"into_id"`
	// The ID of the being merged region.
	// If the region ID equals this ID, it will be merged by the control region.
	FromId           uint64 `protobuf:"varint,3,opt,name=from_id,json=fromId" json:"from_id"`
	XXX_unrecognized []byte `json:"-"`
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.State |= (MergeState(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
